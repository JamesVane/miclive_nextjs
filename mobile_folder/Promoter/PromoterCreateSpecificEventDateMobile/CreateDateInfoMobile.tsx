...
interface CreateDateInfoMobileProps {
	dateErrorMessage: string;
	setDateErrorMessage: React.Dispatch<React.SetStateAction<string>>;
}

function CreateDateInfoMobile({
	dateErrorMessage,
	setDateErrorMessage,
}: CreateDateInfoMobileProps) {
	...
	return (
		<>
			...
			<div className={styles.base_event_paper}>
				<Paper square className={styles.bottom_paper_nav}>
					<div className={styles.bottom_paper_div_helper}>
						<Button
							size="small"
							disabled={!formIsValid}
							onClick={() =>
								dispatch(switchPage({ page: "specificEventDesc" }))
							}
...
export default CreateDateInfoMobile;
