	...
	return (
		<>
			...
			<div className={styles.base_event_paper}>
				...
				/>
				<div className={styles.not_sure_box}>
					<PriorityHighRounded
						sx={{ translate: "25px", height: "40px", width: "40px" }}
					/>
					Changes will apply to all dates attached to this base event
				</div>
...
export default EditBaseEventMobile;
