...
import ReactionBubbleDesktop from "./ReactionBubbleDesktop";
...
function TextMessageGroupDesktop({
	messages,
	time,
	whoSent,
	meToThemId,
		...
		<>
			...
			{time === 0 ? null : (
				<>
					...
					<div className={styles.divider_horiz} style={{ width: "45%" }}>
...
export default TextMessageGroupDesktop;
