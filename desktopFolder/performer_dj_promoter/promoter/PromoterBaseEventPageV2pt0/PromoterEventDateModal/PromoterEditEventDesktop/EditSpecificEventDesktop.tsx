...
function EditSpecificEventDesktop({
	...
	return (
		<>
			...
			<div className={styles.specific_event_main}>
				<div className={styles.specific_splitter}>
					<DatePicker
						disablePast
						value={
							specificEvent.start_date
						...
						sx={{ width: "90%", marginTop: "20px", zIndex: "1000" }}
						label="Select Date"
					/>
...
export default EditSpecificEventDesktop;
