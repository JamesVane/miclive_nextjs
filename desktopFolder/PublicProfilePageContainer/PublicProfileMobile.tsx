...
function PublicProfileMobile() {
	...
	return (
		<>
			...
			<div className={styles.mobile_background_fade} />
			<div className={styles.mobile_main_content_div}>
				<div className={styles.header_div_mobile}>
					<div className={styles.mobile_app_bar}>
						<Image
							alt="logo"
							src={horizLogo}
							style={{ width: "90px", marginLeft: "5px" }}
						/>
						<div className={styles.mobile_row_top}>
							<Button
								size="small"
								color="secondary"
					...
					<div className={styles.mobile_person_avatar_name_tag}>
						<div className={styles.mobile_person_avatar}>
							<AvatarSimpleMobile
								id={208}
								type="performer"
								username="estgee"
						...
						<div className={styles.name_tag_mobile}>
							<div className={styles.mobile_person_name}>EST Gee</div>
							<div className={styles.person_tag_mobile}>I NEVER FELT NUN</div>
						</div>
					</div>
				</div>
				<div className={styles.mobile_socials_div}>
					<Avatar
						sx={{
							height: "35px",
							width: "35px",
...
export default PublicProfileMobile;
